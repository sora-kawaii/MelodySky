...
public enum ClickGuiRenderUtil {
   ...
   private static final ClickGuiRenderUtil[] $VALUES = new ClickGuiRenderUtil[]{INSTANCE};
   ...
   public static void drawBorderedRect(float x, float y, float x1, float y1, float width, int borderColor) {
      ClickGuiRenderUtil.R2DUtils.enableGL2D();
      glColor(borderColor);
      ClickGuiRenderUtil.R2DUtils.drawRect(x + width, y, x1 - width, y + width);
      ClickGuiRenderUtil.R2DUtils.drawRect(x, y, x + width, y1);
      ClickGuiRenderUtil.R2DUtils.drawRect(x1 - width, y, x1, y1);
      ClickGuiRenderUtil.R2DUtils.drawRect(x + width, y1 - width, x1 - width, y1);
      ClickGuiRenderUtil.R2DUtils.disableGL2D();
   }
   ...
   public static void drawRainbowRect(double x, double y, double x2, double y2) {
      ...
      for(int i = 0; (double)i <= width; ++i) {
         ...
         drawRect(x + (double)i, y, x + (double)i + 1.0, y2, color.getRGB());
      }
