...
extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        float appendX = this.logs.length * (this.logStart == 0 ? 1 : this.logStart) / (this.logs.length / 25) - 25;
        ...
        for (String log : this.logs) {
            ...
            if (log.contains("2.5.2") && (log = (Object)((Object)EnumChatFormatting.AQUA) + log).contains("[B2]")) {
                log = (Object)((Object)EnumChatFormatting.GREEN) + StringUtils.stripControlCodes(log);
            }
            if (log.contains("[HEY]")) {
                log = (Object)((Object)EnumChatFormatting.RED) + log;
            }
            font.drawString(log, (float)(6 + x * 340) - (float)this.logStart * 42.5f, i * 16 + 71 - x * 400, new Color(255, 255, 255, this.alpha).getRGB());
            ++i;
        }
