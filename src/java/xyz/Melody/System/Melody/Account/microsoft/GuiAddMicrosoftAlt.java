...
extends GuiScreen {
    ...
    public GuiAddMicrosoftAlt(GuiScreen parentScreen) {
            ...
            public void run() {
                try {
                    ...
                    if (GuiAddMicrosoftAlt.this.microsoftLogin != null) {
                        ((GuiAddMicrosoftAlt)GuiAddMicrosoftAlt.this).microsoftLogin.status = (Object)((Object)EnumChatFormatting.RED) + "Failed " + e.getClass().getName() + ":" + e.getMessage();
                        GuiAddMicrosoftAlt.this.microsoftLogin.close();
                    }
                    GuiAddMicrosoftAlt.this.closed = true;
                }
