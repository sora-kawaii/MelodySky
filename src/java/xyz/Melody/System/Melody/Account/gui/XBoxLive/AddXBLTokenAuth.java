...
public final class AddXBLTokenAuth
extends GuiScreen {
    ...
    public AddXBLTokenAuth(GuiScreen previousScreen) {
    ...
    private void lambda$actionPerformed$0() {
        try {
            ...
            Client.instance.getAccountManager().addAlt(new XBLTokenAlt(username, XBLToken, xstsToken_f, xstsToken_s, accessToken, uuid, "mojang"));
