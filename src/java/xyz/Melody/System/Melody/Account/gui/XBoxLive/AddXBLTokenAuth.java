...
extends GuiScreen {
    ...
    public AddXBLTokenAuth(GuiScreen guiScreen) {
        ...
        if (guiButton.id == 997) {
            new Thread(() -> {
                try {
                    ...
                    Client.instance.getAccountManager().addAlt(new XBLTokenAlt(string3, string, string4, string5, string2, string6, "mojang"));
