...
public final class GaoNengManager {
    public static Map<String, GaoNeng> gaoNengs = new HashMap<String, GaoNeng>();
    public static Map<String, GaoNeng> loading_gaoNengs = new HashMap<String, GaoNeng>();
    public static String forUrl = "https://tool.msirp.cn/api.txt";
