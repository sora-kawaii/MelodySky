...
extends Module {
    ...
    public void onEnable() {
        ...
        if (this.bruhSir == null) {
            this.bruhSir = new Browser("https://www.baidu.com/", "MelodySky Internet Surfing", true, true, (boolean)((Boolean)this.onTop.getValue()), (int)((float)sr.getScaledWidth() / 0.6f), (int)((double)sr.getScaledHeight() / 0.5), JWebBrowser.useEdgeRuntime());
        }
        super.onEnable();
    }

    @EventHandler
    private void tickBruhsir(EventTick e) {
