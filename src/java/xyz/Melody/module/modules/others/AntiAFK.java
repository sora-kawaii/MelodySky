...
extends Module {
    ...
    @EventHandler
    private void tickTimer(EventTick event) {
    ...
    @EventHandler
    private void tickRotation(EventTick event) {
    ...
    @EventHandler
    private void tickMove(EventTick event) {
        if (this.shouldMove) {
            int firstStep = this.mc.gameSettings.keyBindLeft.getKeyCode();
            int secondStep = this.mc.gameSettings.keyBindRight.getKeyCode();
            if (!this.moveDone) {
                if (!this.moved) {
