...
public final class ColorUtils {
    ...
    public static String getHexName(Color color) {
        ...
        return ((StringBuilder)((Object)((StringBuilder)((Object)(rHex.length() == 2 ? rHex : "0" + rHex))).toString())).toString() + (gHex.length() == 2 ? gHex : "0" + gHex) + (bHex.length() == 2 ? bHex : "0" + bHex);
    }
    ...
    public static Color getArmorColor(float armor, float maxArmor) {
        float[] fractions = new float[]{0.0f, 0.33f, 0.66f, 1.0f};
        Color[] colors = new Color[]{new Color(Colors.DARKGREY.c), new Color(Colors.GRAY.c), new Color(Colors.DARKBLUE.c), new Color(Colors.BLUE.c)};
        float progress = armor / maxArmor;
        return ColorUtils.blendColors(fractions, colors, progress).brighter();
    }
